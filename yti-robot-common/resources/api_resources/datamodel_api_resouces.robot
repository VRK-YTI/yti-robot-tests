...
Create profile ${model} with prefix ${prefix} api
    ...
    ...             ..\\yti-robot-common\\resources\\api_resources\\json_files\\datamodel_profile_create.json
    ...             ${model}
    ...             ${prefix}
...
Create vocabulary ${model} with prefix ${prefix} api
    ${headers}=     Create authentication header
    ${json}=        Create datamodel json from file
    ...             ..\\yti-robot-common\\resources\\api_resources\\json_files\\datamodel_vocabulary_create.json
    ...             ${model}
    ...             ${prefix}
    ${response}=    Put         ${CREATE_MODEL_API_POINT}     headers=${headers}  data=${json}
    [Return]        ${response}
...
Add class ${prefix} to model ${model}
    ...
    ...             ..\\yti-robot-common\\resources\\api_resources\\json_files\\datamodel_create_class.json
    ...             ${model}
    ...             ${prefix}
    ${data}=        catenate
