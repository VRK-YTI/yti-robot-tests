...
${DEFAULT TERMINOLOGY NAME}         Auto
${DEFAULT CONCEPT NAME}             Auto_Con
${DEFAULT COLLECTION NAME}          Auto_Col
${DEFAULT TERMINOLOGY PREFIX}       auto_pre

${DEFAULT DATAMODEL NAME}           auto
${DEFAULT DATAMODEL PREFIX}         pr

${DEFAULT DATAMODEL CLASS NAME}     auto_c
${DEFAULT DATAMODEL CLASS PREFIX}   cl

${DEFAULT DATAMODEL ATTRIBUTE NAME}     auto_at
${DEFAULT DATAMODEL ATTRIBUTE PREFIX}   at

${DEFAULT DATAMODEL ASSOCIATION NAME}     auto_as
${DEFAULT DATAMODEL ASSOCIATION PREFIX}   as
...
Set default datamodel variables
    ...
    Set Test Variable    ${DEFAULT DATAMODEL ASSOCIATION NAME}        ${DEFAULT DATAMODEL ASSOCIATION NAME}_${test_case_id.lower()}
    Set Test Variable    ${DEFAULT DATAMODEL ASSOCIATION PREFIX}      ${DEFAULT DATAMODEL ASSOCIATION PREFIX}_${test_case_id.lower()}
