...
Select And Edit Predicate
    ...
    Wait Until Element Is Enabled    ${predicate_tab}
...
Select And Edit Class
    ...
    Click Element with wait    ${CLASS_TAB}
...
Add Link
    ...
    Input Text with wait    ${LINK_URL_INPUT}    ${url}     timeout=30
    Input Text with wait    ${LINK_NAME_INPUT}    ${name}   timeout=30
    Input Text with wait   ${LINK_DESCRIPTION_INPUT}    ${description}      timeout=30
